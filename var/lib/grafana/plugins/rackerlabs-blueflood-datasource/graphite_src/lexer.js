...
System.register(['lodash'], function (_export, _context) {
    ...
    var _, _createClass, unicodeLetterTable, identifierStartTable, i, identifierPartTable, i2, Lexer;
    ...
    return {
        ...
        execute: function () {
            ...
            for (i2 = 0; i2 < 128; i2++) {
                identifierPartTable[i2] = identifierStartTable[i2] || // $, _, A-Z, a-z
                i2 >= 48 && i2 <= 57; // 0-9
            }
